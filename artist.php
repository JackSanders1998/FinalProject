...
<?php
	...
	$query = "INSERT INTO amp.artists 
		(username, stagename, city, state, genre1, genre2, bio, website, spotify, applemusic, 
		soundcloud, youtube)
		VALUES ('$username', '$stagename', '$city', '$state', '$genre1', '$genre2', '$bio', '$website', 
